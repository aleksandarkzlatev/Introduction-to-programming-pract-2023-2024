...
14. Задача: “Кафе автомат”

Описание:

Напиши програма, която симулира работа на кафе автомат.
Потребителят въвежда каква напитка иска (кафе, чай или горещ шоколад) и колко пари има.
Автоматът проверява дали сумата е достатъчна и връща съобщение какво се случва.

Условия:

Използвай switch, за да избереш напитката.
...
Използвай if, за да провериш дали потребителят има достатъчно пари.

Ако има достатъчно → „Вземете вашата напитка!“

Ако няма → „Недостатъчна сума!“

Ако напитката не съществува → „Невалидна опция!“
